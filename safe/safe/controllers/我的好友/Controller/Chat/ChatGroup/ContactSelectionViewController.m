...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_ourUserArray.count > 0) {
        NSString *imgUrl = [self want:2 who:buddy.username];
//        NSString *imgUrl = @"http://www.baidu.com/img/bd_logo1.png";
        cell.imageView.clipsToBounds = YES;
        [cell.imageView sd_setImageWithURL:[NSURL URLWithString:imgUrl] placeholderImage:[UIImage imageNamed:@"icon_logo"]];
        cell.textLabel.text = [self want:1 who:buddy.username];
...
- (void)reloadFooterView
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        remarkView.image = [UIImage imageNamed:@"icon_logo"];
