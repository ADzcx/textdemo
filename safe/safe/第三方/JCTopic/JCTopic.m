...
-(void)upDate{
    ...
    for (id obj in self.pics) {
        ...
        [pic setFrame:CGRectMake(i*(SCREEN_WIDTH - 70),0, SCREEN_WIDTH - 70, SCREEN_HEIGHT - 190)];
        ...
        UIImageView *headView = [[UIImageView alloc]initWithFrame:CGRectMake(5, 5, 40, 40)];
        headView.layer.cornerRadius = 20;
        headView.clipsToBounds = YES;
        
        
        [headView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",[obj objectForKey:@"headPic"]]] placeholderImage:[UIImage imageNamed:@"icon_logo"]];
        
        [pic addSubview:headView];
        [self addSubview:pic];
