    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.contentView.frame.size.width+20, 1)];
...
-(void)layoutSubviews{
    ...
    [self.imageView imageWithUsername:[NSString stringWithFormat:@"%@",_imageURL] placeholderImage:_placeholderImage];
    self.imageView.frame = CGRectMake(10, 7, 46, 46);
